...
You can now receive real-time notifications for email events via webhooks. Configure webhook endpoints to track deliveries, bounces, complaints, and more. [Learn more](https://docs.bytesend.cloud/guides/webhooks)
...
<Frame>
    <img src="https://bytesend.cloud/hero-dark.webp" alt="Rebranded ByteSend hero" />
</Frame>
...
From now on we [ByteSend](https://bytesend.cloud). Make sure to update your docker image and sdks.
