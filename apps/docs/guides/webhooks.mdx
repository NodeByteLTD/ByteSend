...
<Steps>
  ...
  <Step title="Add webhook in dashboard">
    Go to [Webhooks](https://app.bytesend.cloud/webhooks) in your ByteSend dashboard and create a new webhook:
...
1. Go to [Webhooks](https://app.bytesend.cloud/webhooks)
