...
export const env = createEnv({
  ...
  server: {
    ...
    STRIPE_FREE_MARKETING_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_FREE_TRANSACTIONAL_USAGE_PRICE_ID: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    STRIPE_FREE_MARKETING_USAGE_PRICE_ID: process.env.STRIPE_FREE_MARKETING_USAGE_PRICE_ID,
    STRIPE_FREE_TRANSACTIONAL_USAGE_PRICE_ID: process.env.STRIPE_FREE_TRANSACTIONAL_USAGE_PRICE_ID,
