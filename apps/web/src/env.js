...
export const env = createEnv({
  ...
  server: {
    ...
    BYTESEND_API_KEY: z.string().optional(),
    ...
    STRIPE_BASIC_MARKETING_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_BASIC_TRANSACTIONAL_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_LITE_PRICE_ID: z.string().optional(),
    STRIPE_LITE_MARKETING_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_LITE_TRANSACTIONAL_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_HOBBY_PRICE_ID: z.string().optional(),
    STRIPE_HOBBY_MARKETING_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_HOBBY_TRANSACTIONAL_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_EXTRA_MEMBER_PRODUCT_ID: z.string().optional(),
    STRIPE_EXTRA_MEMBER_USAGE_PRICE_ID: z.string().optional(),
    STRIPE_ADDITIONAL_DOMAIN_PRODUCT_ID: z.string().optional(),
    STRIPE_ADDITIONAL_DOMAIN_PRICE_ID: z.string().optional(),
    ...
    SMTP_USER: z.string().default("bytesend"),
    ...
    GITLAB_REPO_ID: z.string().optional(),
    GITLAB_RELEASE_TOKEN: z.string().optional(),
  },
  ...
  runtimeEnv: {
    ...
    BYTESEND_API_KEY: process.env.BYTESEND_API_KEY,
    ...
    STRIPE_BASIC_MARKETING_USAGE_PRICE_ID: process.env.STRIPE_BASIC_MARKETING_USAGE_PRICE_ID,
    STRIPE_BASIC_TRANSACTIONAL_USAGE_PRICE_ID: process.env.STRIPE_BASIC_TRANSACTIONAL_USAGE_PRICE_ID,
    STRIPE_LITE_PRICE_ID: process.env.STRIPE_LITE_PRICE_ID,
    STRIPE_LITE_MARKETING_USAGE_PRICE_ID: process.env.STRIPE_LITE_MARKETING_USAGE_PRICE_ID,
    STRIPE_LITE_TRANSACTIONAL_USAGE_PRICE_ID: process.env.STRIPE_LITE_TRANSACTIONAL_USAGE_PRICE_ID,
    STRIPE_HOBBY_PRICE_ID: process.env.STRIPE_HOBBY_PRICE_ID,
    STRIPE_HOBBY_MARKETING_USAGE_PRICE_ID: process.env.STRIPE_HOBBY_MARKETING_USAGE_PRICE_ID,
    STRIPE_HOBBY_TRANSACTIONAL_USAGE_PRICE_ID: process.env.STRIPE_HOBBY_TRANSACTIONAL_USAGE_PRICE_ID,
    STRIPE_EXTRA_MEMBER_PRODUCT_ID: process.env.STRIPE_EXTRA_MEMBER_PRODUCT_ID,
    STRIPE_EXTRA_MEMBER_USAGE_PRICE_ID: process.env.STRIPE_EXTRA_MEMBER_USAGE_PRICE_ID,
    STRIPE_ADDITIONAL_DOMAIN_PRODUCT_ID: process.env.STRIPE_ADDITIONAL_DOMAIN_PRODUCT_ID,
    STRIPE_ADDITIONAL_DOMAIN_PRICE_ID: process.env.STRIPE_ADDITIONAL_DOMAIN_PRICE_ID,
    ...
    GITLAB_REPO_ID: process.env.GITLAB_REPO_ID,
    GITLAB_RELEASE_TOKEN: process.env.GITLAB_RELEASE_TOKEN,
  },
  /**
