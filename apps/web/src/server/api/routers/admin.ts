  ...
  rejectWaitlistUser: adminProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const text = [
        "Hello,",
        "",
        "Sorry, We cannot proceed with this request at this time, this might affect ByteSend\u2019s sending reputation.",
        "",
        "",
        "cheers,",
        "koushik - useSend.com",
      ...
      try {
        await sendMail(
          user.email,
          "ByteSend: Waitlist request update",
          text,
          toPlainHtml(text),
          replyTo,
          fromOverride,
